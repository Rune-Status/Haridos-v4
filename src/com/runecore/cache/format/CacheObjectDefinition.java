...
public class CacheObjectDefinition {
    ...
    private void readValues(RSByteBuffer stream, int opcode) throws IOException {
                                                ...
                                                if (opcode < 30 || opcode >= 35) {
                                                    if (opcode == 40) {
                                                        ...
                                                        for (int i_72_ = 0; i_71_ > i_72_; i_72_++) {
                                                            aShortArray3920[i_72_] = (short) stream.readUnsignedShort();//i think these are i dont remember :L
                                                            aShortArray3919[i_72_] = (short) stream.readUnsignedShort();//there are multiple models used in objects
                                                            //Ffs..
                                                        }
                                                    }
                                                } else
    ...
    private void method3297(RSByteBuffer stream) throws IOException {
    ...
    private void readValueLoop(RSByteBuffer stream) throws IOException {
        for (; ; ) {
...
//
//	final CacheObjectDefinition getChild(CacheObjectDefinition parent) {
//		int i = -1;
//		if (configFileId != -1) {
//			i = method63(configFileId);
//		} else if (configId != -1) {
//			i = method62(configId);
//		}
//		if (i < 0 || childrenIds.length - 1 <= i || childrenIds[i] == -1) {
//			int i_47_ = childrenIds[childrenIds.length - 1];
//			if (i_47_ != -1) {
//				return forId(i_47_);
//			}
//			return null;
...
//	}
//
//	public final int method62(int i) {
//		return anIntArray5373[i];
//	}
//
//	public final int method63(int i) {
//		CacheObjectChildDefinition class281 = CacheObjectChildDefinition.valueOf(i);
//		int i_19_ = class281.anInt3737;
//		int i_20_ = class281.anInt3743;
//		int i_21_ = class281.anInt3742;
//		int i_22_ = Class182.anIntArray2701[-i_20_ + i_21_];
//		return anIntArray5373[i_19_] >> i_20_ & i_22_;
//	}
    ...
    public static CacheObjectDefinition forId(int objectID) {
        ...
        if (is != null) {
            try {
                objectDef.readValueLoop(new RSByteBuffer(new RSByteArrayInputStream(is)));
            } catch (IOException e) {
