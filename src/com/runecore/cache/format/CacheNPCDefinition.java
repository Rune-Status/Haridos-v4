...
public class CacheNPCDefinition {
    ...
    public static HashMap<Integer, CacheNPCDefinition> npcDefs = new HashMap<Integer, CacheNPCDefinition>();
    ...
    public static CacheNPCDefinition forID(int npcID) {
        ...
        if (is != null) {
            try {
                npcDef.readValueLoop(new RSByteBuffer(new ByteArrayInputStream(is)));
            } catch (IOException e) {
    ...
    private void readValueLoop(RSByteBuffer stream) throws Exception {
        for (; ; ) {
    ...
    private void readValues(int opcode, RSByteBuffer stream) throws Exception {
        switch (opcode) {
            case 163:
                stream.readByte();
                break;
    ...
    /**
     * Gets the NPC's head icon.
     * @return The head icon value.
     */
